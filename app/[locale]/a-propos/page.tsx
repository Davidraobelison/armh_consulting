  ...
  return (
    <>
      ...
      <Section className="bg-sky-50">
        <Container>
          <h2 className="text-3xl md:text-4xl font-semibold mb-6 text-sky-900">
            L'histoire de ARMH Consulting
          </h2>

          <div className="space-y-6 text-lg text-sky-800/80 leading-relaxed">
            <p>
      ...
      <Section className="bg-sky-100">
        <Container>
          <h2 className="text-3xl md:text-4xl font-semibold mb-10 text-sky-900">
            Mission & valeurs
          </h2>

          <div className="grid md:grid-cols-3 gap-10 text-center">
            <div className="bg-white/70 rounded-2xl p-8 shadow-sm border border-sky-100">
              <h3 className="text-xl font-medium mb-3 text-sky-800">Engagement</h3>
            ...
            <div className="bg-white/70 rounded-2xl p-8 shadow-sm border border-sky-100">
              <h3 className="text-xl font-medium mb-3 text-sky-800">Expertise</h3>
              <p className="text-sky-700/80">
            ...
            <div className="bg-white/70 rounded-2xl p-8 shadow-sm border border-sky-100">
              <h3 className="text-xl font-medium mb-3 text-sky-800">Durabilité</h3>
              <p className="text-sky-700/80">
      ...
      <Section className="bg-sky-50">
        <Container>
          ...
          <p className="text-lg text-sky-800/80 max-w-4xl">
