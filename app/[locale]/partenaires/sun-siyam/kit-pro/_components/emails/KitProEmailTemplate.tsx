...
KitProEmailTemplate.PreviewProps = {
  prenom: "Marie",
  nom: "Dupont",
  societe: "Agence Soleil Voyages",
  fonction: "Responsable produit",
  email: "marie.dupont@soleil-voyages.fr",
  ...
  besoin: "lune-de-miel",
  volume: "regulier",
  message: "Je cherche des arguments pour vendre Iru Veli à des couples premium.",
} as KitProEmailTemplateProps;
